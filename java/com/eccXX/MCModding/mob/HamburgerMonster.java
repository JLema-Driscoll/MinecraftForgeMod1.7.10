...
public class HamburgerMonster extends EntityFlying implements IMob
{
    ...
    public HamburgerMonster(World p_i1735_1_)
    {
        super(p_i1735_1_);
        ...
        if (this.targetedEntity != null && this.targetedEntity.getDistanceSqToEntity(this) < d4 * d4)
        {
            ...
            if (this.canEntityBeSeen(this.targetedEntity))
            {
                ...
                if (this.attackCounter == 20)
                {
                    ...
                    EntityTomato thingz = new EntityTomato(this.worldObj, d5,d6,d7);
                    this.worldObj.spawnEntityInWorld(thingz);
