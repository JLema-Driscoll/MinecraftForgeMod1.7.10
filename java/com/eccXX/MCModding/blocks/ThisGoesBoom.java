...
public class ThisGoesBoom extends Block
{

    private static final String __OBFID = "CL_00000324";

    public ThisGoesBoom(String unlocalizedName)
    {
        super(Material.tnt);
    ...
    public void onBlockDestroyedByExplosion(World p_149723_1_, int p_149723_2_, int p_149723_3_, int p_149723_4_, Explosion p_149723_5_)
    {
        ...
        {
        	BoomEntity boom = new BoomEntity(p_149723_1_);
    ...
    public void func_150114_a(World p_150114_1_, int p_150114_2_, int p_150114_3_, int p_150114_4_, int p_150114_5_, EntityLivingBase p_150114_6_)
    {
        if (!p_150114_1_.isRemote)
        {
            if ((p_150114_5_ & 1) == 1)
            {
            	BoomEntity boom= new BoomEntity(p_150114_1_, (double)((float)p_150114_2_ + 0.5F), (double)((float)p_150114_3_ + 0.5F), (double)((float)p_150114_4_ + 0.5F), p_150114_6_);
              ...
              //  p_150114_1_.spawnEntityInWorld(entitytntprimed); 
                p_150114_1_.spawnEntityInWorld(boom); 
